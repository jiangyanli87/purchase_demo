    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'id', title: 'ID',align:"center", width: "10%",  unresize: true, sort: true}
                , {field: 'm_num', title: '物料编码',align:"center", width:  "10%"}
                ...
                , { title: '操作', align: 'center', toolbar: '#table_bar', width:  "12%"}
            ]]
            , page: true
            ,id : 'materList',
