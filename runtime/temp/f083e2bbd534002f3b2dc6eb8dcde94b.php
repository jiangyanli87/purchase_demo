<?php /*a:3:{s:64:"E:\TP5.0\purchase\application\purchase\view\index\edit_item.html";i:1622433179;s:62:"E:\TP5.0\purchase\application\purchase\view\public\header.html";i:1622880787;s:62:"E:\TP5.0\purchase\application\purchase\view\public\footer.html";i:1620956778;}*/ ?>
    ...
    <form class="layui-form">
        ...
        <div class="layui-form-item" style="margin: 28px -12px 28px -40px">
            ...
            <div class="layui-input-inline">
                <input type="text" name="id" value="<?php echo htmlentities($edit_item['id']); ?>" style="display: none;">
                <input type="text" name="c_name" value="<?php echo htmlentities($edit_item['c_name']); ?>" lay-verify="required" autocomplete="off" class="layui-input" style="width: 160px;">
            </div>
        </div>
