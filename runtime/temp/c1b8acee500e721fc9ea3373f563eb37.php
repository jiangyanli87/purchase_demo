<?php /*a:3:{s:63:"E:\TP5.0\purchase\application\purchase\view\index\go_check.html";i:1623046335;s:62:"E:\TP5.0\purchase\application\purchase\view\public\header.html";i:1622880787;s:62:"E:\TP5.0\purchase\application\purchase\view\public\footer.html";i:1620956778;}*/ ?>
...
<div class="x-body" >
    <form class="layui-form">
        <div class="layui-form-item">
            <label class="layui-form-label">审核意见</label>
             <div class="layui-input-block">
              <input name="is_notice" value="1" type="radio" title="通过" >
              <input name="is_notice" value="0" type="radio" title="不通过">
              <input name="is_notice" value="2" type="radio" title="驳回">
             </div>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label" style="margin-top: -2px;">备注说明</label>
             <div class="layui-input-block">
                <textarea class="textarea" id="numberId" placeholder="请输入原因" maxlength="200" required lay-verify="required"></textarea>
                <span class="layui-form-label" style="position: absolute;right: 40px;bottom:10px; width: 55px;">
        ...
        <div class="layui-form-item" style="float: right;margin-right: -15px;margin-top: 20px;">
