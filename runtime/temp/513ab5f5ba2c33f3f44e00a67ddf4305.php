            ...
            <div class="">
               ...
               <div class="p-b-item">
                ...
                <div class="p-b-item d-dr-jsb aic">
                    ...
                    <button class="layui-btn right-btn" >查看合同</button>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div style='border-right: none; display:flex;justify-content: space-between;'>
                        <div style="display:flex;justify-content: space-between;">
                            <div class="layui-input-block" style="display: flex;">
                                <input type="checkbox" style="margin-top: 17px;margin-right: 20px;" name="CSDN" lay-filter="like" title="复选框一" value="dongsir">
                                <div class="company" style="margin-top: 14px;margin-right: 70px;" >朱东晨公司</div>
                        ...
                        <div style="width: 0px;height: 40px;border: 1px solid #E6E6E6;"></div>
                        <div style="">
                        ...
                        <div  style="width: 0px;height: 40px;border: 1px solid #E6E6E6;"></div>
                        <div style="">
                            <div class="enfold"><span class="detail_title">付款方式</span><span class="detail_content" >一次靠港</span></div> 
                            <div class="enfold"><span class="detail_title">产地</span><span class="detail_content" >苏州</span></div> 
                        </div>
                        <div  style="width: 0px;height: 40px;border: 1px solid #E6E6E6;"></div>
                        <div style="">
                            <div class="enfold"><span class="detail_title">报价备注</span><span class="detail_content" style="padding-left: 58px;">--</span></div> 
                        </div>
                    </div>
