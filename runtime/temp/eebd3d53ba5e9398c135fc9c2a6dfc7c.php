<?php /*a:4:{s:60:"E:\TP5.0\purchase\application\admin\view\auth\rule_list.html";i:1621937652;s:63:"E:\TP5.0\purchase\application\admin\view\layout\table_base.html";i:1620956776;s:59:"E:\TP5.0\purchase\application\admin\view\public\header.html";i:1622879853;s:59:"E:\TP5.0\purchase\application\admin\view\public\footer.html";i:1620956776;}*/ ?>
<!doctype html>
    ...
    layui.use(['table', 'form'], function () {
        ...
        table.on('tool(table_ele)', function (obj) {
            ...
            if (obj.event === 'del') {
                ...
                xadmin.open('编辑权限','<?php echo url("editRule"); ?>?id=' +data.id,480,440)
            }
        });
        var $ = layui.$, active = {
            reload: function () {
        ...
        form.on('switch(status)', function (data) {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo url("changRuleStatus"); ?>',
                data: send_data,
                dataType: 'json',
                success(res) {
                    layer.msg(res.msg)
        ...
        $('#add').click(function(){
            xadmin.open('添加权限','<?php echo url("addRule"); ?>',480,440)
        })
    })
</script>
