<?php /*a:4:{s:64:"E:\TP5.0\purchase\application\purchase\view\index\need_list.html";i:1623234423;s:66:"E:\TP5.0\purchase\application\purchase\view\layout\table_base.html";i:1622876892;s:62:"E:\TP5.0\purchase\application\purchase\view\public\header.html";i:1622880787;s:62:"E:\TP5.0\purchase\application\purchase\view\public\footer.html";i:1620956778;}*/ ?>
<!doctype html>
...
//这里设置表格的宽度为100%
        ...
        table.on('tool(table_ele)', function (obj) {
            ...
            if (obj.event === 'del') {
                ...
                xadmin.open('详情','<?php echo url("pur_item"); ?>?p_id='+data.id,1078,516)
            }
        });
        var $ = layui.$, active = {
            reload: function () {
        ...
        $('#add').click(function(){
            xadmin.open('添加','<?php echo url("add_need"); ?>',910,575)
        })
    })
</script>
