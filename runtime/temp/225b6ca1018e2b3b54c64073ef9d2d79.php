<?php /*a:4:{s:71:"E:\TP5.0\purchase\application\purchase\view\index\offer_msg_record.html";i:1623748150;s:66:"E:\TP5.0\purchase\application\purchase\view\layout\table_base.html";i:1622876892;s:62:"E:\TP5.0\purchase\application\purchase\view\public\header.html";i:1622880787;s:62:"E:\TP5.0\purchase\application\purchase\view\public\footer.html";i:1620956778;}*/ ?>
<!doctype html>
    ...
    <div class="item">
        ...
        <div class="layui-input-inline">
            <select name="search_key" lay-verify="required" id="search_key" class="layui-input">
                ...
                <?php if(is_array($send_info) || $send_info instanceof \think\Collection || $send_info instanceof \think\Paginator): $i = 0; $__LIST__ = $send_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <option value="<?php echo htmlentities($key); ?>"><?php echo htmlentities($vo); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
