<?php /*a:4:{s:68:"E:\TP5.0\purchase\application\purchase\view\index\for_checkings.html";i:1623143459;s:66:"E:\TP5.0\purchase\application\purchase\view\layout\table_base.html";i:1622876892;s:62:"E:\TP5.0\purchase\application\purchase\view\public\header.html";i:1622880787;s:62:"E:\TP5.0\purchase\application\purchase\view\public\footer.html";i:1620956778;}*/ ?>
<!doctype html>
        ...
        <div class="pur-body d-dc-jc">
            ...
            <div class="">
               ...
               <div class="p-b-item">
                ...
                <div class="p-b-item d-dr-jsb aic">
                    <button class="layui-btn left-btn" onclick="quotation_record()">报价记录</button>
                    <button class="layui-btn right-btn" >需求详情</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="info-item d-dr">
        <table class="layui-table">
            ...
            <tr>
                ...
                <th style="width: 100px;">所需金额合计</th>
                <th>—</th>
            </tr>
            <tr>
                <th>采购备注</th>
            ...
            <tr>
                <td colspan="8">
                    <div  style="border-right:none;display:flex;justify-content: space-between;">
                        <div style="display:flex;justify-content: space-between;">
                            <input type="checkbox" style="margin-top: 18px;margin-left: 10px;">
                            <div class="company" style="margin-top: 14px;margin-left: 10px;" >朱东晨公司</div>
                            <div style="margin-left: 80px;">
                                <div class="enfold"><span class="detail_title">确认数量（单位）</span><span class="detail_content" >王梦珂</span></div> 
                                <div class="enfold"><span class="detail_title">数量（单位）</span><span class="detail_content" >4000（吨）</span></div> 
                            </div>
                        </div>
                       
                        <div class="parcel" >
                            <div class="enfold"><span class="detail_title">运费</span><span class="detail_content" style="padding-left: 20px;">二次承兑</span></div> 
                            <div class="enfold"><span class="detail_title">账期</span><span class="detail_content" style="padding-left: 55px;">15</span></div> 
                           
                        </div>
                        <div class="parcel" >
                            <div class="enfold"><span class="detail_title">付款方式</span><span class="detail_content" style="padding-left: 55px;">一次靠港</span></div> 
                            <div class="enfold"><span class="detail_title">产地</span><span class="detail_content" style="padding-left:25px;">苏州</span></div> 
...
<script type="text/javascript">
    layui.use(['table', 'form', 'laydate', 'laypage', 'laytpl'], function () {
        ...
        //报价记录
        window.quotation_record=function(){
            xadmin.open("报价记录", '<?php echo url("quotation_record"); ?>',1078,620)
        }
    });
</script>
