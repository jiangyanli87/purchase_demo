<?php /*a:3:{s:60:"E:\TP5.0\purchase\application\admin\view\auth\edit_rule.html";i:1621937652;s:59:"E:\TP5.0\purchase\application\admin\view\public\header.html";i:1622879853;s:59:"E:\TP5.0\purchase\application\admin\view\public\footer.html";i:1620956776;}*/ ?>
<!doctype html>
...
<div class="x-body">
    <form class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select lay-filter="pid" name="pid" id='pid' lay-verify="required" lay-search>
                    <option value="0" <?php if(0 == $rule['pid']): ?> selected <?php endif; ?>>顶级菜单</option>
                    <?php if(is_array($rules) || $rules instanceof \think\Collection || $rules instanceof \think\Paginator): $i = 0; $__LIST__ = $rules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <option value="<?php echo htmlentities($vo['id']); ?>" <?php if($vo['id'] == $rule['pid']): ?> selected <?php endif; ?>><?php echo htmlentities(str_repeat(' 丨---',$vo['level']-1)); ?><?php echo htmlentities($vo['title']); ?></option>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="checkbox" value="1" <?php if($rule['status']==1): ?>checked <?php endif; ?> lay-verify="status" id="status" name="status" lay-skin="switch" lay-text="显示|隐藏" lay-filter="status">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">权限名称</label>
            <div class="layui-input-inline">
                <input type="text" name="title" value="<?php echo htmlentities($rule['title']); ?>" lay-verify="required" autocomplete="off" placeholder="请输入权限名称" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">访问路由</label>
            <div class="layui-input-inline">
                <input type="text" name="name" lay-verify="required" value="<?php echo htmlentities($rule['name']); ?>" autocomplete="off" placeholder="请输入访问路由" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">图标</label>
            <div class="layui-input-inline">
                <input type="text" name="icon" lay-verify="icon" value="<?php echo htmlentities($rule['icon']); ?>" autocomplete="off" placeholder="请输入图标" class="layui-input">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" name="sort" value="<?php echo htmlentities($rule['sort']); ?>" lay-verify="required" autocomplete="off" placeholder="请输入排序参数" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
